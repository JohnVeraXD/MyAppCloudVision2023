package com.example.myappcloudvision2023;
...
public class MainActivity extends AppCompatActivity {
    ...
    // la peticion de la Api debe estar dentro de un hilo para no congelar el telefono
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //La manera como procesa la respuesta esto es para texto
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //La manera como procesa la respuesta esto es para imagenes
